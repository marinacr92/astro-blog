...
# si dejamos la ruta de las imágenes apuntando a la carpeta public, Astro no va a poder adaptar las imágenes porque no tiene control solbre ellas. Hay que crear en src una carpeta con las mismas imágenes si se quieren adaptar
